...
@REM @SET @CURR_DIR=%currentfolder%
@SET @CURR_DIR="PostcodeAnywhere"
...
@"C:\Program Files\7-Zip\7z.exe" a -ttar -so %@CURR_DIR%.tar app package.xml | "C:\Program Files\7-Zip\7z.exe" a -si %@CURR_DIR%.tgz 
@GOTO SUCCESS
